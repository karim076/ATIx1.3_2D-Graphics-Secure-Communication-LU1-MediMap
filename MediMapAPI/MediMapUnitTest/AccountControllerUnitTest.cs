...
public class AccountControllerUnitTest
{
    ...
    [DataRow("EnesTekinbas51", "FOUTWACHTWOORD!", "enes@hotmailcom", "Wachtwoord moet minimaal een kleine letter bevatten.")]
    [DataRow("EnesTekinbas51", "foutwachtwoord51.", "enes@hotmailcom", "Wachtwoord moet minimaal een hoofdletter bevatten.")]
    [DataRow("EnesTekinbas51", "FoutWachtwoord!", "enes@hotmailcom" , "Wachtwoord moet minimaal een cijfer bevatten.")]
    [DataRow("EnesTekinbas51", "FoutWachtwoord51", "enes@hotmail.com", "Wachtwoord moet minimaal een speciaal teken bevatten.")]
